          ...
          (openBlock(), createElementBlock(Fragment, null, renderList(items, (item) => {
            return createBaseVNode("div", {
              ...
              createBaseVNode("div", _hoisted_4, [
                ...
                createBaseVNode("div", null, toDisplayString(item.bathrooms) + " " + toDisplayString(item.bedrooms) + " " + toDisplayString(item.garage) + " " + toDisplayString(item.size), 1)
              ])
            ]);
          }), 64))
        ])
...
exports.FloorplanList = FloorplanList;
